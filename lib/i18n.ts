...
const STRINGS = {
  ...
  todaySessionPreparing: { es: "Preparando tu sesión…", en: "Preparing your session…" },
  todaySessionSaved: { es: "Progreso guardado", en: "Progress saved" },
  todaySessionRemaining: { es: "Tiempo restante", en: "Time remaining" },
  todaySessionNow: { es: "Ahora", en: "Now" },
  todaySessionSaving: { es: "Guardando…", en: "Saving…" },
  todayStepOf: { es: "de", en: "of" },
  todayOpenActivity: { es: "Abrir esta práctica", en: "Open this practice" },
  todayFinishReflection: { es: "Terminar la sesión", en: "Finish the session" },
  todayTransition: { es: "Guardando y preparando el siguiente paso…", en: "Saving and preparing the next step…" },
  ...
  todayTechnicalTitle: { es: "Fue un problema técnico", en: "That was a technical issue" },
  todayTechnicalSafe: {
    es: "Tu progreso está seguro. Esto no cuenta como un error tuyo.",
    en: "Your progress is safe. This does not count as a learner mistake.",
  },
  todayTechnicalNoScore: {
    es: "No guardamos una calificación ni cambiamos tu nivel.",
    en: "No score was recorded, and your level did not change.",
  },
  todayTechnicalRetry: { es: "Intentar de nuevo", en: "Try again" },
  todayTechnicalListen: { es: "Continuar escuchando", en: "Continue with listening" },
  todayReturnSession: { es: "Volver a la sesión", en: "Return to session" },
  todayCompletionPracticed: { es: "Lo que practicaste", en: "What you practiced" },
  todayCompletionImproved: { es: "Mejora observada", en: "Evidence of improvement" },
  todayCompletionImprovedNeutral: {
    es: "Esta sesión no registró una comparación válida de antes y después.",
    en: "This session did not record a valid before-and-after comparison.",
  },
  todayCompletionReview: { es: "Para repasar", en: "Review next" },
  todayCompletionNoPracticeEvidence: {
    es: "No se registró evidencia de práctica en esta sesión.",
    en: "No practice evidence was recorded in this session.",
  },
  todayCompletionNoMistakeEvidence: {
    es: "No se registró un error específico para repasar.",
    en: "No specific mistake was recorded for review.",
  },
  todayCompletionReward: { es: "Recompensa de la sesión", en: "Session reward" },
  todayCompletionRewardPending: {
    es: "Guardando tu recompensa…",
