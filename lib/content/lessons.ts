...
export const LESSONS: Lesson[] = [
  ...
  // ── 5. /h/ ───────────────────────────────────────────────────────────────
  {
    ...
    items: words("h", [
      ...
      { text: "honest", ipa: "/ˈɑːnɪst/", phoneme: "silent-h", hint: "Silent h — say 'onist'.", note: "Silent h" },
      { text: "honor", ipa: "/ˈɑːnər/", phoneme: "silent-h", hint: "Silent h — say 'onor'.", note: "Silent h" },
    ]),
  },
  ...
  // ── 6. s-cluster onsets ──────────────────────────────────────────────────
  {
    ...
    items: words("s-clusters", [
      ...
      { text: "stop", ipa: "/stɑːp/", phoneme: "st", hint: "Begin on the s, not 'estop'." },
  ...
  // ── 7. -ed endings ───────────────────────────────────────────────────────
  {
    ...
    items: words("ed-endings", [
      ...
      { text: "watched", ipa: "/wɑːtʃt/", phoneme: "t", hint: "'watcht' — ends in a sharp t." },
      ...
      { text: "wanted", ipa: "/ˈwɑːntɪd/", phoneme: "ɪd", hint: "Add a FULL syllable: 'want-id'." },
  ...
  // ── 9. schwa /ə/ ─────────────────────────────────────────────────────────
  {
    ...
    items: words("schwa", [
      ...
      { text: "problem", ipa: "/ˈprɑːbləm/", phoneme: "ə", hint: "Second vowel reduces: 'PROB-luhm'." },
  ...
  // ── 10. word stress ──────────────────────────────────────────────────────
  {
    ...
    items: words("word-stress", [
      ...
      { text: "photography", ipa: "/fəˈtɑːɡrəfi/", phoneme: "2", hint: "Stress moves to the second: pho-TOG-ra-phy." },
      ...
      { text: "object", ipa: "/ˈɑːbdʒɪkt/", phoneme: "noun", hint: "An OBject (stress first).", note: "noun" },
...
const SENTENCES: Record<string, { text: string; ipa: string; phoneme: string; hint: string }[]> = {
  "i-vs-ii": [
    ...
    { text: "I want to live near the sea", ipa: "/aɪ wɑːnt tə lɪv nɪr ðə siː/", phoneme: "sentence", hint: "Short lazy i in 'live', then stretch the 'sea'." },
  ...
  h: [
    ...
    { text: "I hope he is honest", ipa: "/aɪ hoʊp hiː ɪz ˈɑːnɪst/", phoneme: "sentence", hint: "Breathe 'hope' and 'he' — but 'honest' has NO h." },
  ...
  "s-clusters": [
    ...
    { text: "Stop at the street sign", ipa: "/stɑːp æt ðə striːt saɪn/", phoneme: "sentence", hint: "Hiss straight into the t — stop, street." },
  ...
  "ed-endings": [
    ...
    { text: "She wanted what she needed", ipa: "/ʃiː ˈwɑːntɪd wʌt ʃiː ˈniːdɪd/", phoneme: "sentence", hint: "Both get the extra syllable: want-id, need-id." },
  ...
  "final-clusters": [
    ...
    { text: "The world watched the films", ipa: "/ðə wɜːrld wɑːtʃt ðə fɪlmz/", phoneme: "sentence", hint: "rld, tcht, lmz — land every consonant." },
    { text: "She helped with the facts", ipa: "/ʃiː hɛlpt wɪð ðə fækts/", phoneme: "sentence", hint: "helpt and fakts — keep the final t." },
  ],
  schwa: [
    { text: "The problem is about supply", ipa: "/ðə ˈprɑːbləm ɪz əˈbaʊt səˈplaɪ/", phoneme: "sentence", hint: "Three lazy 'uh's: the, a-, su-." },
  ...
  "word-stress": [
    { text: "I want to record a record", ipa: "/aɪ wɑːnt tuː rɪˈkɔːrd ə ˈrɛkɔːrd/", phoneme: "sentence", hint: "Verb first: re-CORD. Then the noun: RE-cord." },
    { text: "Please present the present", ipa: "/pliːz prɪˈzɛnt ðə ˈprɛzənt/", phoneme: "sentence", hint: "pre-SENT (give), PRE-sent (gift)." },
    { text: "Photography starts with a photo", ipa: "/fəˈtɑːɡrəfi stɑːrts wɪð ə ˈfoʊtoʊ/", phoneme: "sentence", hint: "pho-TOG-ra-phy, then PHO-to — feel the punch move." },
  ],
};
