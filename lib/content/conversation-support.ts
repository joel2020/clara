...
export const SUPPORT_LESSONS: Lesson[] = [
  {
    ...
    items: chunks("sup-open", [
      { text: "Thank you for calling, my name is Mariana", ipa: "/θæŋk juː fɔːr ˈkɔːlɪŋ maɪ neɪm ɪz/", meaning: "Gracias por llamar, mi nombre es Mariana", hint: "'Thank' con th soplada. 'calling' = 'CO-ling'." },
      { text: "How can I help you today?", ipa: "/haʊ kæn aɪ hɛlp juː təˈdeɪ/", meaning: "¿Cómo le puedo ayudar hoy?", hint: "Se junta: 'jau-ka-nai-HELP-yu'." },
      ...
      { text: "Can you confirm the email on the account?", ipa: "/kæn juː kənˈfɜːrm ði ˈiːmeɪl ɒn ði əˈkaʊnt/", meaning: "¿Me confirma el correo de la cuenta?", hint: "'confirm' con r americana: 'con-FERM'." },
  ...
  },
  {
    ...
    items: chunks("sup-repeat", [
      { text: "I'm sorry, could you say that again?", ipa: "/aɪm ˈsɒri kʊd juː seɪ ðæt əˈɡɛn/", meaning: "Disculpe, ¿me lo repite?", hint: "Nunca digas solo 'what?'. Empieza con 'I'm sorry'." },
      ...
      { text: "Sorry, the line is breaking up", ipa: "/ˈsɒri ðə laɪn ɪz ˈbreɪkɪŋ ʌp/", meaning: "Disculpe, la línea se está cortando", hint: "'breaking up' = se corta. Culpa la línea, no al cliente." },
      ...
      { text: "One moment, I want to get this right", ipa: "/wʌn ˈmoʊmənt aɪ wɒnt tuː ɡɛt ðɪs raɪt/", meaning: "Un momento, quiero hacerlo bien", hint: "Compra tiempo y suena cuidadosa, no lenta." },
      ...
      { text: "I want to make sure I don't get it wrong", ipa: "/aɪ wɒnt tuː meɪk ʃʊr aɪ doʊnt ɡɛt ɪt rɒŋ/", meaning: "Quiero asegurarme de no equivocarme", hint: "Convierte tu duda en cuidado profesional." },
  ...
  },
  {
    ...
    items: chunks("sup-empathy", [
      ...
      { text: "I'm really sorry about that", ipa: "/aɪm ˈrɪli ˈsɒri əˈbaʊt ðæt/", meaning: "Lamento mucho eso", hint: "Disculpa por la situación, sin admitir culpa." },
  ...
  },
  {
    ...
    items: chunks("sup-hold", [
      { text: "May I place you on hold for two minutes?", ipa: "/meɪ aɪ pleɪs juː ɒn hoʊld fɔːr tuː ˈmɪnɪts/", meaning: "¿Me permite ponerlo en espera dos minutos?", hint: "Pide permiso y da el tiempo. Nunca solo 'hold on'." },
      ...
      { text: "Let me stay on the line with you", ipa: "/lɛt miː steɪ ɒn ðə laɪn wɪð juː/", meaning: "Permítame quedarme en la línea con usted", hint: "'stay on the line' = no colgar. Tranquiliza." },
      ...
      { text: "I don't want to keep you waiting", ipa: "/aɪ doʊnt wɒnt tuː kiːp juː ˈweɪtɪŋ/", meaning: "No quiero hacerlo esperar", hint: "'keep you waiting' = hacerlo esperar." },
  ...
  },
  {
    ...
    items: chunks("sup-explain", [
      ...
      { text: "What happened was a system error", ipa: "/wʌt ˈhæpənd wɒz ə ˈsɪstəm ˈɛrər/", meaning: "Lo que pasó fue un error del sistema", hint: "Explica sin culpar a nadie ni a ti misma." },
      ...
      { text: "I'm sending you a confirmation email", ipa: "/aɪm ˈsɛndɪŋ juː ə ˌkɒnfərˈmeɪʃən ˈiːmeɪl/", meaning: "Le estoy enviando un correo de confirmación", hint: "Cierra el ciclo. Reduce llamadas repetidas." },
  ...
  },
  {
    ...
    items: chunks("sup-spell", [
      ...
      { text: "B as in boy, not V as in Victor", ipa: "/biː æz ɪn bɔɪ nɒt viː æz ɪn ˈvɪktər/", meaning: "B de burro, no V de Victor", hint: "Tu confusión número uno. Practícala en voz alta." },
      ...
      { text: "At gmail dot com", ipa: "/æt ˈdʒiːmeɪl dɒt kɒm/", meaning: "Arroba gmail punto com", hint: "'at' = arroba, 'dot' = punto. Nunca 'arroba'." },
      { text: "Your confirmation number is one two three", ipa: "/jɔːr ˌkɒnfərˈmeɪʃən ˈnʌmbər ɪz wʌn tuː θriː/", meaning: "Su número de confirmación es uno dos tres", hint: "Dígito por dígito, con pausas. No 'ciento veintitrés'." },
  ...
  },
  {
    ...
    items: chunks("sup-close", [
      ...
      { text: "I'm glad we got that resolved", ipa: "/aɪm ɡlæd wiː ɡɒt ðæt rɪˈzɒlvd/", meaning: "Me alegra que lo hayamos resuelto", hint: "'resolved' = resuelto. 'we' comparte el logro." },
  ...
  },
  {
    ...
    items: chunks("sup-limits", [
      { text: "I'm not able to do that, but here's what I can do", ipa: "/aɪm nɒt ˈeɪbəl tuː duː ðæt bʌt hɪrz wʌt aɪ kæn duː/", meaning: "No puedo hacer eso, pero esto sí puedo hacer", hint: "El patrón completo. Nunca el 'no' solo." },
      ...
      { text: "The policy doesn't allow that, unfortunately", ipa: "/ðə ˈpɒlɪsi ˈdʌzənt əˈlaʊ ðæt ʌnˈfɔːrtʃənətli/", meaning: "La política no lo permite, desafortunadamente", hint: "'policy' = política. Al final suaviza." },
      { text: "What I can offer is a replacement", ipa: "/wʌt aɪ kæn ˈɒfər ɪz ə rɪˈpleɪsmənt/", meaning: "Lo que puedo ofrecer es un reemplazo", hint: "Redirige a lo posible. Estructura muy útil." },
      { text: "I'd rather be honest with you", ipa: "/aɪd ˈræðər biː ˈɒnɪst wɪð juː/", meaning: "Prefiero serle honesta", hint: "'I'd rather' = preferiría. Gana confianza." },
      ...
      { text: "I don't want to promise something I can't deliver", ipa: "/aɪ doʊnt wɒnt tuː ˈprɒmɪs ˈsʌmθɪŋ aɪ kænt dɪˈlɪvər/", meaning: "No quiero prometer algo que no pueda cumplir", hint: "Convierte un no en integridad." },
    ]),
  },
  {
    id: "sup-interview",
    ...
    items: chunks("sup-interview", [
      ...
      { text: "I'm working on speaking more confidently in English", ipa: "/aɪm ˈwɜːrkɪŋ ɒn ˈspiːkɪŋ mɔːr ˈkɒnfɪdəntli ɪn ˈɪŋɡlɪʃ/", meaning: "Estoy trabajando en hablar inglés con más confianza", hint: "Debilidad real más acción. Nunca 'no tengo debilidades'." },
      { text: "I'm interested in this company because you support customers worldwide", ipa: "/aɪm ˈɪntrəstɪd ɪn ðɪs ˈkʌmpəni bɪˈkɒz juː səˈpɔːrt ˈkʌstəmərz ˈwɜːrldwaɪd/", meaning: "Me interesa esta empresa porque atienden clientes en todo el mundo", hint: "Menciona algo específico de ellos. Se nota." },
