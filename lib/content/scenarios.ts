...
// roleplay where Joel plays a role and Mariana talks back — the same six
...
export const SCENARIOS: Scenario[] = [
  {
    ...
    role: "a friendly new coworker meeting Mariana for the first time",
    setting:
      "You just met Mariana at work. Make small introductions — names, where she is from, what she does — the way two friendly coworkers meet on a first day.",
    opener: { en: "Hi! I'm Joel. Nice to meet you. What's your name?", es: "¡Hola! Soy Joel. Mucho gusto. ¿Cómo te llamas?" },
    starters: ["Hi, I'm Mariana.", "Nice to meet you too.", "I'm from Colombia."],
  },
  {
    id: "cafe",
    emoji: "☕",
    ...
    role: "a warm barista at a coffee shop taking Mariana's order",
    setting:
      "Mariana walks into your coffee shop. Take her order step by step — greet her, ask what she'd like, offer a size, ask about food, and handle paying. Keep it easy and friendly.",
  ...
  },
  {
    ...
    role: "a kind stranger on the street helping Mariana find her way",
    setting:
      "Mariana is a little lost and stops you on the street. Help her get where she's going — ask where she wants to go, then give simple directions (left, right, straight, next to). Be patient and clear.",
  ...
  },
  {
    ...
    setting:
      "Mariana is browsing in your clothing store. Help her shop — ask if she needs help, talk about sizes and prices, let her try things on, and finish the sale. Keep the language simple.",
  ...
  },
  {
    ...
    role: "a friendly neighbor chatting with Mariana",
    setting:
      "You bump into Mariana in the hallway. Make warm small talk — the weather, her day, her weekend, her work. Keep it light and short, and keep the conversation going with easy questions.",
    opener: { en: "Hey Mariana! Beautiful day, isn't it? How's your day going?", es: "¡Hola Mariana! Bonito día, ¿no? ¿Cómo va tu día?" },
  ...
  },
  {
    ...
    role: "a friend inviting Mariana to do something this week",
    setting:
      "You're Mariana's friend and you'd like to make plans with her this week — coffee, a walk, something easy. Invite her, agree on a day and time, and set it up. Keep it casual and warm.",
