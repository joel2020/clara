...
export const CONVERSATION_LESSONS: Lesson[] = [
  {
    ...
    items: chunks("conv-greetings", [
      { text: "Hi, how are you?", ipa: "/haɪ haʊ ɑːr juː/", meaning: "Hola, ¿cómo estás?", hint: "Una sola ola: 'hai-hau-ar-yú'. La h es un soplido suave, nunca una j fuerte." },
      ...
      { text: "My name is Ana", ipa: "/maɪ neɪm ɪz ˈænə/", meaning: "Me llamo Ana", hint: "'name is' se une: 'nei-mis'. Di tu propio nombre al practicar." },
      ...
      { text: "How do you say this in English?", ipa: "/haʊ də juː seɪ ðɪs ɪn ˈɪŋɡlɪʃ/", meaning: "¿Cómo se dice esto en inglés?", hint: "'do you' se relaja: 'hau-da-yu-séi'. Úsala en cada clase." },
  ...
  },
  {
    ...
    items: chunks("conv-directions", [
      ...
      { text: "How do I get to the airport?", ipa: "/haʊ də aɪ ɡɛt tə ðə ˈɛrpɔːrt/", meaning: "¿Cómo llego al aeropuerto?", hint: "Plantilla universal: 'hau-da-ai-GET-tu...' + lugar. La h, un soplido suave." },
  ...
  },
  {
    ...
    items: chunks("conv-smalltalk", [
      { text: "How's your day going?", ipa: "/haʊz jɔːr deɪ ˈɡoʊɪŋ/", meaning: "¿Cómo va tu día?", hint: "'How's' = 'hauz', termina en z suave. Sube en 'going?'." },
      ...
      { text: "Have a good day!", ipa: "/hæv ə ɡʊd deɪ/", meaning: "¡Que tengas buen día!", hint: "Se une todo: 'ha-va-gud-DEI', h suave. Despídete siempre así." },
    ]),
  },
  {
    id: "conv-plans",
  ...
  {
    id: "conv-american",
    title: "Sound American",
    subtitle: "Inglés casual",
    description: "How Americans really talk — reductions and everyday expressions.",
    kind: "phrase",
    categoryIds: ["conversation"],
    track: "conversation",
    order: 27,
    intro: {
      summary: "Real American English isn't the textbook. People say 'gonna', 'wanna', 'gotta' — learn these and you'll both sound natural and finally understand fast speech.",
      whyTricky:
        "Books teach 'going to' and 'want to', but no American says them fully in conversation. If you only know the slow forms, you freeze when you hear the real ones — and you sound like a textbook.",
      how: [
        "Learn the reduced form as ONE sound: gonna, wanna, gotta, lemme, gimme.",
        "The American T between vowels is a soft D: 'gotta' = 'GA-da', 'you got it' = 'ya-GA-dit'.",
        "Keep the American R strong everywhere: 'worries', 'here', 'for'.",
      ],
      exampleIds: ["conv-american:3", "conv-american:1"],
    },
    items: chunks("conv-american", [
      { text: "What's up?", ipa: "/wʌts ʌp/", meaning: "¿Qué tal? · ¿Qué hubo?", hint: "Saludo súper casual. Se aprieta: 'wat-SÁP'." },
      { text: "How's it going?", ipa: "/haʊz ɪt ˈɡoʊɪŋ/", meaning: "¿Cómo va todo?", hint: "'How's it' se une: 'hau-sit-GO-in'. El saludo americano diario." },
      { text: "I'm gonna go", ipa: "/aɪm ˈɡʌnə ɡoʊ/", meaning: "Voy a ir", hint: "'going to' = 'gonna' ('GA-na'). Nadie dice 'going to' completo al hablar." },
      { text: "Do you wanna come?", ipa: "/də jə ˈwɑːnə kʌm/", meaning: "¿Quieres venir?", hint: "'want to' = 'wanna' ('WA-na'). 'Do you' se relaja a 'd'ya'." },
      { text: "I gotta go", ipa: "/aɪ ˈɡɑːɾə ɡoʊ/", meaning: "Me tengo que ir", hint: "'got to' = 'gotta'. La t es una d suave americana: 'GA-da'." },
      { text: "Lemme see", ipa: "/ˈlɛmi siː/", meaning: "Déjame ver", hint: "'let me' = 'lemme'. Corta y natural." },
      { text: "Gimme a second", ipa: "/ˈɡɪmi ə ˈsɛkənd/", meaning: "Dame un segundo", hint: "'give me' = 'gimme'. Muy común." },
      { text: "For here or to go?", ipa: "/fɔːr hɪr ɔːr tə ɡoʊ/", meaning: "¿Para acá o para llevar?", hint: "La pregunta clásica del café en EE. UU. 'to go' = para llevar." },
      { text: "Sounds good!", ipa: "/saʊndz ɡʊd/", meaning: "¡Suena bien!", hint: "Tu 'sí' americano por excelencia. 'sounds' termina en dz." },
      { text: "No worries", ipa: "/noʊ ˈwɜːriz/", meaning: "No hay problema", hint: "R americana fuerte en 'worries': 'WER-iz'." },
      { text: "You got it", ipa: "/jə ˈɡɑːɾɪt/", meaning: "Claro · Hecho", hint: "'got it' con d suave: 'ya-GA-dit'. Significa 'entendido / hecho'." },
      { text: "Awesome, thanks!", ipa: "/ˈɔːsəm θæŋks/", meaning: "¡Genial, gracias!", hint: "'awesome' = genial, muy americano: 'Á-som'." },
    ]),
  },
  {
    id: "conv-american-2",
    title: "Sound American II",
    subtitle: "Más inglés casual",
    description: "The next level of street English — kinda, dunno, gotcha, and friends.",
    kind: "phrase",
    categoryIds: ["conversation"],
    track: "conversation",
    order: 28,
    intro: {
      summary: "Round two of real American speech: the tiny casual phrases friends actually trade all day.",
      whyTricky:
        "These are almost never in textbooks, but Americans use them constantly — miss 'gotcha' or 'I dunno' and half of casual conversation goes over your head.",
      how: [
        "Learn each one as a single sound with a feeling attached, not word by word.",
        "'kinda' = kind of, 'dunno' = don't know, 'gotcha' = got you, 'ya' = you.",
        "Say them fast and relaxed — pronouncing them carefully ruins them.",
      ],
      exampleIds: ["conv-american-2:2", "conv-american-2:9"],
    },
    items: chunks("conv-american-2", [
      { text: "It's kinda cold", ipa: "/ɪts ˈkaɪndə koʊld/", meaning: "Está como frío", hint: "'kind of' = 'kinda' ('KAIN-da'). Suaviza cualquier opinión." },
      { text: "I dunno", ipa: "/aɪ dəˈnoʊ/", meaning: "No sé", hint: "'I don't know' relajado al máximo: 'ai-da-NO'." },
      { text: "Gotcha!", ipa: "/ˈɡɑːtʃə/", meaning: "¡Te entendí! · ¡Te pillé!", hint: "'got you' = 'GA-cha'. Confirma que entendiste." },
      { text: "Hang on a second", ipa: "/hæŋ ɑːn ə ˈsɛkənd/", meaning: "Espera un segundo", hint: "Se encadena: 'hang-ON-a-SE-kend', con h soplada al inicio." },
      { text: "No way!", ipa: "/noʊ weɪ/", meaning: "¡No puede ser!", hint: "Tu sorpresa americana. Alarga: 'nou-UEI'." },
      { text: "For real?", ipa: "/fɔːr riːl/", meaning: "¿En serio?", hint: "R americana doble: 'for-RIL'. Sube al final." },
      { text: "My bad", ipa: "/maɪ bæd/", meaning: "Culpa mía", hint: "Disculpa casual entre amigos. Corta y sin drama." },
      { text: "That works", ipa: "/ðæt wɜːrks/", meaning: "Eso me sirve", hint: "TH con voz + 'works' con r americana: 'uérks'." },
      { text: "I'm down", ipa: "/aɪm daʊn/", meaning: "Me apunto", hint: "'Estar down' = querer hacer el plan. 'aim-DAUN'." },
      { text: "Take it easy", ipa: "/teɪk ɪt ˈiːzi/", meaning: "Tranquilo · Cuídate", hint: "Despedida relajada: 'tei-ki-dI-zi' con d suave." },
      { text: "What's the plan?", ipa: "/wʌts ðə plæn/", meaning: "¿Cuál es el plan?", hint: "'What's the' se aprieta: 'wats-tha-PLAN'." },
      { text: "See ya!", ipa: "/siː jə/", meaning: "¡Nos vemos!", hint: "'see you' = 'see ya' ('si-ya'). El adiós de todos los días." },
    ]),
  },
];
