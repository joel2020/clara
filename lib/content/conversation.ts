...
export const CONVERSATION_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    items: chunks("conv-american", [
      ...
      { text: "How's it going?", ipa: "/haʊz ɪt ˈɡoʊɪŋ/", meaning: "¿Cómo va todo?", hint: "'How's it' se une: 'jau-sit-GO-in'. El saludo americano diario." },
  ...
  },
  {
    ...
    items: chunks("conv-american-2", [
      ...
      { text: "Hang on a second", ipa: "/hæŋ ɑːn ə ˈsɛkənd/", meaning: "Espera un segundo", hint: "Se encadena: 'jang-ON-a-SE-kend'." },
