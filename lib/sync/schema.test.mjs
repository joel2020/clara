...
const BUILDER_TABLES = { attemptRow: "attempts", examRow: "exam_attempts", callRow: "call_scores", talkRow: "talk_sessions", dailySessionRow: "daily_sessions" };
for (const m of src.matchAll(/function (attemptRow|examRow|callRow|talkRow|dailySessionRow)\([^)]*\) \{\s*return \{/g)) {
