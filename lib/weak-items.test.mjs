...
const weak = (itemId) => ({ itemId, box: 0, attempts: 4, passes: 1, lastResult: false, due: 0, updatedAt: 1 });
...
const ranked = weakestItems(
  [
    { itemId: "conv-cafe:1", box: 3, attempts: 4, passes: 4, lastResult: true, due: 0, updatedAt: 1 }, // strongest
    weak("conv-cafe:2"), // weakest
    { itemId: "conv-cafe:3", box: 1, attempts: 4, passes: 2, lastResult: false, due: 0, updatedAt: 1 },
  ],
  3,
  { track: "conversation" },
);
