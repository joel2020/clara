...
import { bandFor, firstWeekPlan } from "./onboarding.ts";
...
eq(nextDifficulty(5, { skill: "grammar", difficulty: 5, correct: true }), 5, "up bounded at C1");
...
eq(bandFor("C1"), "advanced", "C1 -> advanced band");
