...
for (const ordinal of [1, 2, 3]) {
  silence = transitionStageSpeaking(silence, { type: "no-speech" }).state;
  assert(silence.learnerMisses === ordinal, `no-speech capture ${ordinal} records exactly one learner miss`);
}
